...
package com.healthcare.healthing.java;
...
import com.healthcare.healthing.Graphic.BitmapUtils;
import com.healthcare.healthing.Graphic.FrameMetadata;
import com.healthcare.healthing.Graphic.GraphicOverlay;
import com.healthcare.healthing.Graphic.ScopedExecutor;
import com.healthcare.healthing.Graphic.TemperatureMonitor;
import com.healthcare.healthing.Graphic.VisionImageProcessor;
import com.healthcare.healthing.preference.PreferenceUtils;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    public Pose processImageProxy(ImageProxy image, GraphicOverlay graphicOverlay) {
        long frameStartMs = SystemClock.elapsedRealtime();
        if (isShutdown) {
            image.close();
            return null;
